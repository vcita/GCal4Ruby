begin
  ...
  Jeweler::Tasks.new do |gemspec|
    ...
    gemspec.files = FileList["README.md", "CHANGELOG", "lib/gcal4ruby.rb", "lib/gcal4ruby/service.rb", "lib/gcal4ruby/calendar.rb", "lib/gcal4ruby/event.rb", "lib/gcal4ruby/free_busy.rb", "lib/gcal4ruby/recurrence.rb"]
  end
